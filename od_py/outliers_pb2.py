...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='od_go',
  syntax='proto3',
  serialized_options=b'Z\"github.com/outlier_detection/od_go',
  serialized_pb=b'\n\x0eoutliers.proto\x12\x05od_go\x1a\x1fgoogle/protobuf/timestamp.proto\"O\n\x06Metric\x12(\n\x04time\x18\x01 \x01(\x0b\x32\x1a.google.protobuf.Timestamp\x12\x0c\n\x04name\x18\x02 \x01(\t\x12\r\n\x05value\x18\x03 \x01(\x01\"1\n\x0fOutliersRequest\x12\x1e\n\x07metrics\x18\x01 \x03(\x0b\x32\r.od_go.Metric\"#\n\x10OutliersResponse\x12\x0f\n\x07indices\x18\x01 \x03(\x05\x32G\n\x08Outliers\x12;\n\x06\x44\x65tect\x12\x16.od_go.OutliersRequest\x1a\x17.od_go.OutliersResponse\"\x00\x42$Z\"github.com/outlier_detection/od_gob\x06proto3'
  ,
...
_METRIC = _descriptor.Descriptor(
  name='Metric',
  full_name='od_go.Metric',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='time', full_name='od_go.Metric.time', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='od_go.Metric.name', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='od_go.Metric.value', index=2,
...
_OUTLIERSREQUEST = _descriptor.Descriptor(
  ...
  full_name='od_go.OutliersRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='metrics', full_name='od_go.OutliersRequest.metrics', index=0,
...
_OUTLIERSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='od_go.OutliersResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='indices', full_name='od_go.OutliersResponse.indices', index=0,
...
Metric = _reflection.GeneratedProtocolMessageType('Metric', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:od_go.Metric)
  })
...
OutliersRequest = _reflection.GeneratedProtocolMessageType('OutliersRequest', (_message.Message,), {
  ...
  '__module__' : 'outliers_pb2'
  # @@protoc_insertion_point(class_scope:od_go.OutliersRequest)
  })
...
OutliersResponse = _reflection.GeneratedProtocolMessageType('OutliersResponse', (_message.Message,), {
  ...
  '__module__' : 'outliers_pb2'
  # @@protoc_insertion_point(class_scope:od_go.OutliersResponse)
  })
...
_OUTLIERS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Detect',
    full_name='od_go.Outliers.Detect',
    index=0,
